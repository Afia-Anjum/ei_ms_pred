...
# mass_dict = {'C': 12, 'H': 1, 'N': 14, 'P': 31, 'Si': 28, 'S': 32, 'O': 16, 'Cl': 35, 'F': 19, 'I': 127, 'Br': 79,
#              'Na': 23}
# # will take the ground state valence only
# valency_dict = {'C': 4, 'H': 1, 'N': 3, 'P': 3, 'Si': 4, 'S': 2, 'O': 2, 'Cl': 1, 'F': 1, 'I': 1, 'Br': 1, 'Na': 1}
...
def guess_formula(smiles_string, mass_array, intensity_array):
    ...
    #this line is needed in the input annotation script only?
    ...
    #when cluster peak elimination strategy is removed, these lines will be uncommented#
    # new_m_by_z_list=mass_array
    # new_intensity_list=intensity_array
                ...
                # or add by a hydrogen
                    ...
                    if local_max_m_by_z[i] == M + 1:
                        if elemental_composition_dict['H']:
                            ...
                            #print("printing anikaaa firsttt.....")
                            #print(local_max_m_by_z[i])
                            #print(tmp_dict)
                            #print(elemental_composition_dict)
