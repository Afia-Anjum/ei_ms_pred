...
class MolDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return smiles, MW_label, MS_label, n_atoms, (path_input, path_mask)
...
def get_loader(raw_data, split_indices, args, shuffle=False,
    ...
    def combine_data(data):
        batch_smiles, batch_MW_labels,batch_MS_labels, batch_n_atoms, batch_path = zip(*data)
        ...
        return batch_smiles, batch_MW_labels, batch_MS_labels, (batch_path_inputs, batch_path_mask)
